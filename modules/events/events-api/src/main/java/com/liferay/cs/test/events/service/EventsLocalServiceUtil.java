 ...
 * <code>com.liferay.cs.test.events.service.impl.EventsLocalServiceImpl</code> and
...
public class EventsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.cs.test.events.service.impl.EventsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Events addEvents(Events events) {
	 ...
	 */
	public static Events createEvents(long eventId) {
	 ...
	 */
	public static Events deleteEvents(Events events) {
	 ...
	 */
	public static Events deleteEvents(long eventId) throws PortalException {
	...
	public static Events fetchEvents(long eventId) {
	 ...
	 */
	public static Events fetchEventsByUuidAndGroupId(
	 ...
	 * @throws PortalException if a events with the primary key could not be found
	 */
	public static Events getEvents(long eventId) throws PortalException {
	 ...
	 */
	public static Events getEventsByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
	 ...
	 */
	public static List<Events> getEventses(int start, int end) {
	 ...
	 */
	public static List<Events> getEventsesByUuidAndCompanyId(
	 ...
	 */
	public static Events updateEvents(Events events) {
	...
	private static volatile EventsLocalService _service;
